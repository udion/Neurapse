...
class DRN_Const():
    ...
    def compute(self, n_out, T, delta_t):
        ...
        DRN = NNetwork_Const(self.Fanout, self.W, self.Tau, self.N, self.N)
...
class DRN_Plastic_B():
    ...
    def compute(self, n_out, T, delta_t):
        ...
        DRN = NNetwork_Plastic_B(self.Fanout, self.W, self.Tau, self.N, self.N)
...
A = DRN_Const(15, 0.8, 0.4)
# A = DRN_Plastic_B(15, 0.8, 0.4)
