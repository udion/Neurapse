...
print('Integrating the power to get total enegry...')

def discrete_integrate(Vals, delta_x):
    sum = 0
    for v in Vals:
        sum += v*delta_x
    return sum
print('Enegry dissipated by Na channles : ', discrete_integrate(P_Na[0, :], delta_t))
print('Enegry dissipated by k channles : ', discrete_integrate(P_k[0, :], delta_t))
